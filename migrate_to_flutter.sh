...
echo ""
echo -e "  2. ${YELLOW}Network blocking API:${NC}"
...
echo ""
echo -e "  3. ${YELLOW}Cosmetic injection API (call before WebView navigates):${NC}"
echo "     // In your InAppWebView onLoadStart / before loadUrl:"
echo "     final bundle = DomainBlockerService.getCosmeticBundle(host);"
echo "     if (bundle.isNotEmpty) {"
echo "       // Inject at AT_DOCUMENT_START for best results:"
echo "       controller.addUserScript(UserScript("
echo "         source: bundle,"
echo "         injectionTime: UserScriptInjectionTime.AT_DOCUMENT_START,"
echo "       ));"
echo "     }"
echo ""
echo -e "  4. ${YELLOW}Run your app:${NC}"
